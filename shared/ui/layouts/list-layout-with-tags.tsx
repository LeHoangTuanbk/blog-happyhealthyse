    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-24">
          <div className="hidden h-full max-h-screen max-w-[280px] min-w-[280px] flex-wrap overflow-auto rounded-sm border bg-gray-50 pt-5 shadow-md transition-shadow duration-300 hover:cursor-pointer hover:shadow-lg sm:flex dark:border-gray-700 dark:bg-gray-900/70 dark:shadow-gray-800/40">
