---
title: 'Container/Presentational Pattern trong React với TypeScript'
date: '2025-01-21'
tags: ['react', 'typescript', 'design-patterns', 'architecture', 'best-practices']
draft: false
summary: 'Tìm hiểu về Container/Presentational pattern trong React - một pattern giúp tách biệt logic và UI, cải thiện khả năng tái sử dụng và test. Bài viết kèm code demo TypeScript thực tế.'
authors: ['default']
layout: 'PostLayout'
---
...
1. **Tách biệt trách nhiệm rõ ràng** - Logic và UI hoàn toàn độc lập
2. **Dễ test hơn** - Presentational components dễ test, Container components tập trung logic
3. **Tái sử dụng cao** - Presentational components có thể sử dụng ở nhiều nơi khác nhau
4. **Dễ maintain** - Thay đổi logic không ảnh hưởng UI và ngược lại
5. **Team collaboration tốt hơn** - Designer có thể tập trung vào Presentational, Developer tập trung vào Container
